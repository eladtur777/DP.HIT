...
namespace A18_Ex01_SagivAbdush_305274946__EladTruzman_300221280
{
    public class FriendPost
    {
        ...
        private string m_FriendImageURL;
        ...
        public FacebookObjectCollection<Comment> FriendComments
        {
            get
            {
                return m_FriendComments;
            }

            set
            {
                m_FriendComments = value;
            }
        }
        ...
        public string FriendImageURL
        {
            get
            {
                return m_FriendImageURL;
            }

            set
            {
                m_FriendImageURL = value;
            }
        }
